import tpr from "root/content/theron_patrick_resume.pdf";

export default {
  profile: `<p>Hello there! My name's Theron, I'm a senior frontend software engineer II at <a href="https://hubspot.com/" target="_blank">HubSpot</a>. I'm also an amateur game developer, adventurous cross-country traveler, and latin dance enthusiast.</p>
  ...
  contact: `<p>To get in touch, please visit my <a href="https://www.linkedin.com/in/theronpatrick/" target="_blank">LinkedIn</a> or email at <a href="mailto:therondevelopment@gmail.com" target="_blank">therondevelopment@gmail.com</a>.</p>`,
  projects: `<p><a href="http://theron.dev/roadtrip" target="_blank">Theron's 2017 Cross-Country Extravaganza</a> - Interactive movies, pictures, and stats from my 3 month journey across America in the summer of 2017.</p>
    ...
    <p><a href="https://itunes.apple.com/us/app/free-mini-golf-scorecard/id566990840" target="_blank">Free Mini Golf Scorecard</a> - A digital replacement for clunky paper-and-pencil scoring at mini golf courses. This was the first app I published years ago, and is due for some refactoring TLC.</p>

    <p><a href="https://www.instagram.com/rumblefest_game/" target="_blank">Rumblefest</a> - Mobile wrestling-themed game blending classic arcade graphics and mechanics with modern touch controls and platforms. Coming soon!</p>
    ...
    `,
  resume: `<p>To review my educational background, professional project descriptions, or if you really hate trees and want to print something out, you can <a href="${tpr}" target="_blank">Download or View my PDF Resumé</a>.</p>`,
};
